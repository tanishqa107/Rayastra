...
>
  <div className="flex items-center justify-between w-[90%] max-w-6xl px-6 py-2 bg-white rounded-full shadow-lg border border-gray-200 backdrop-blur-lg">
    ...
    <div className="flex items-center gap-8">
      {["How it works", "Use cases", "Pricing", "Help", "Careers"].map(
        (link) => {
    ...
    <div className="flex items-center gap-4">
      ...
      onClick={()=>navigate("/signupform")}
       className="flex hover:cursor-pointer items-center gap-1 bg-black text-white px-4 py-2 rounded-full font-medium hover:bg-gray-800 transition">
